...
<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <div class="col py-3">
                ...
                <form method="POST" action="tambahmobil_exe.php" enctype="multipart/form-data">
...
<div class="mb-3 row">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name="statusPenyewaan">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name="kondisiMobil">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input class="form-control" type="file" name="viewMobil">
    </div>
  </div>
