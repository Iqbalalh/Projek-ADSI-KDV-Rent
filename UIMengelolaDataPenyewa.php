            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $result['noTelp']; ?></td>
                        <td>
                            <a href="FormMengubahDataPenyewa.php?update=<?php echo $result['idPenyewa']; ?>">
                                <img width="45" height="45" src="img/editlogo.png" alt="Edit" class="btn-img">
                            </a>
                            
                            <a href="FormMenghapusDataPenyewa.php?idPenyewa=<?php echo $result['idPenyewa']; ?>" onclick="return confirm('Apakah Anda yakin menghapus data ini?');">
