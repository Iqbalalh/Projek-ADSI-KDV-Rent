<?php
include "koneksi.php";
$sql = mysqli_query($conn,  "SELECT * FROM supir where idSupir = '$_GET[update]'");
...
<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="namaSupir" value="<?php echo $result['namaSupir']; ?>">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name="umurSupir" value="<?php echo $result['umurSupir']; ?>">
    </div>
  </div>
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name="statusSupir" value="<?php echo $result['statusSupir']; ?>">
    </div>
  </div>
...
if(isset($_POST['update'])){
    mysqli_query($conn, "UPDATE supir SET
    namaSupir = '$_POST[namaSupir]',
    jenisKelamin = '$_POST[jenisKelamin]',
    umurSupir = '$_POST[umurSupir]',
    statusSupir = '$_POST[statusSupir]' WHERE idSupir=$_GET[update]") or die(mysqli_error($conn));

    echo "<script>alert('Data Tersimpan');
    document.location='UIMengelolaDataSupir.php'</script>";
