...
<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            ...
            <div class="col py-3">
                ...
                <a href="FormMenambahDataSupir.php">
            ...
            <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?= $result['namaSupir']; ?></td>
                        <td><?= $result['jenisKelamin']; ?></td>
                        <td><?= $result['umurSupir']; ?></td>
                        <td><?= $result['statusSupir']; ?></td>
                        <td>
                            <a href="FormMengubahDataSupir.php?update=<?php echo $result['idSupir']; ?>">
                                <img width="45" height="45" src="img/editlogo.png" alt="Edit" class="btn-img">
                            </a>
                            
                            <a href="FormMenghapusDataSupir.php?idSupir=<?php echo $result['idSupir']; ?>" onclick="return confirm('Apakah Anda yakin menghapus data ini?');">
